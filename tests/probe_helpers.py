"""Shared fixtures for deterministic model-probe tests."""
...
from fm_lab.diagnostics.probes.manifest import build_probe_manifest
...
def probe_toy_config(root: Path, output_dir: Path) -> dict[str, Any]:
...
def build_probe_fixture(tmp_path: Path):
    ...
    config = probe_toy_config(root, tmp_path / "run")
