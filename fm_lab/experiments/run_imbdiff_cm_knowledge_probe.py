...
def _render_report(summary: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "the general preactivation, and a fixed random adapter preserving the learned ",
        "`B @ A` product's factor rank and complete singular spectrum while randomizing ",
        "its singular subspaces. The adapter is applied to the same activation.",
        "",
