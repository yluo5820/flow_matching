...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--model-output",
        default=None,
        choices=("source", "target", "velocity"),
    ...
    parser.add_argument(
        ...
        default=None,
        choices=("source", "target", "velocity"),
        help="Override objective.loss_space for flow matching objectives.",
    )
    parser.add_argument(
        "--prediction-min-denom",
        type=float,
        default=None,
        help="Override objective.min_denom for prediction-space conversions.",
    )
    parser.add_argument(
        "--straightness-weight",
        type=float,
...
def _objective_overrides(args: argparse.Namespace) -> dict:
    ...
    if args.loss_space is not None:
        objective["loss_space"] = args.loss_space
    if args.prediction_min_denom is not None:
        objective["min_denom"] = args.prediction_min_denom
