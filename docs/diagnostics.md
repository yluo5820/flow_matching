...
permutation and planted-subspace controls, subspace directions, and reversible
parameter perturbations.

These are hypothesis-neutral library primitives. Callers own scientific
hypotheses, layer and sample selection rules, statistical decisions, and
follow-up actions. The discontinued long-tail gradient-geometry protocols are
summarized in `docs/long_tail_geometry_postmortem.md`.
